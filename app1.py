...
st.title("Comunidades de los jubilados de la Seguridad Social")
st.header("IMSS-ISSSTE")
st.header("")

st.subheader(" ")

st.markdown('<div style="text-align: justify; font-size: 30px">A muchas personas les gusta la idea de vivir en una comunidad para jubilados, en particular una dirigida a adultos de 60 años o más que ofrece servicios como gimnasios, piscinas y clases de cocina. Estas comunidades a menudo se parecen más a clubes de campo que a viviendas para personas mayores.</div>', unsafe_allow_html=True)
...
st.sidebar.success("Seleccione una página de la parte de arriba.")
